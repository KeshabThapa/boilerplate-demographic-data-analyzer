...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich_np = len(higher_education[higher_education.salary == '>50K'])
    higher_education_total_np = len(higher_education)
    higher_education_rich = round(higher_education_rich_np / higher_education_total_np * 100, 1)

    lower_education_rich_np = len(lower_education[lower_education.salary == '>50K'])
    lower_education_total_np = len(lower_education)
    lower_education_rich = round(lower_education_rich_np / lower_education_total_np * 100, 1)
